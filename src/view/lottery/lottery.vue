<template>
  <div class="wap" v-title="'抽奖'" ref="wap">
    ...
    <div class="box">
      <div v-for="imgLi in prizeList" ref="pice" :style="{'backgroundImage':'url('+imgLi.bgSrc+')'}">
  ...
  methods: {
    ...
    get () {
      this.$http.get('../../../static/data/lotteryInfo.json').then((myData) => {
        ...
        if (res.success) {
          ...
          res.data.prizeInfo.splice(5, 0, ' ')
          res.data.prizeInfo.splice(6, 0, ' ')
          res.data.prizeInfo.splice(9, 0, ' ')
    ...
    statusFun (c, s, e) {
      this.$nextTick(() => {
        if (c < s) { // 当前时间小于开始时间，未开始
          this.startStatus = 0
          this.$refs.pice[5].style.backgroundImage = 'url(' + notStart + ')'
          this.$refs.pice[6].style.backgroundImage = 'url(' + notStart + ')'
          this.$refs.pice[9].style.backgroundImage = 'url(' + notStart + ')'
          this.$refs.pice[10].style.backgroundImage = 'url(' + notStart + ')'
        } else if (c > s && c < e) { // 当前时间大于开始时间，并且小于结束时间，已经开始未结束
          this.startStatus = 1
          this.$refs.pice[5].style.backgroundImage = 'url(' + prizeBtn + ')'
          this.$refs.pice[6].style.backgroundImage = 'url(' + prizeBtn + ')'
          this.$refs.pice[9].style.backgroundImage = 'url(' + prizeBtn + ')'
          this.$refs.pice[10].style.backgroundImage = 'url(' + prizeBtn + ')'
        } else if (c > e) { // 当前时间大于结束时间，已经结束
          this.startStatus = 2
          this.$refs.pice[5].style.backgroundImage = 'url(' + endLottery + ')'
          this.$refs.pice[6].style.backgroundImage = 'url(' + endLottery + ')'
          this.$refs.pice[9].style.backgroundImage = 'url(' + endLottery + ')'
    ...
    move () {
      if (this.prizeIndex === 0) {
        this.$refs.pice[this.arrNum[11]].style.backgroundImage = 'url(' + noSelect + ')'
